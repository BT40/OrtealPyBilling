...
class GtkNewSale():   
    ...
    def billingpage(self, mainwindow):      
       ...
       # item1label.set_markup("Item 1 to be billed")
        ...
        self.freightentry.set_width_chars(10)
        ...
        invoicemorebutton.set_margin_left(180)
        ...
        gridfooter.add(freightlabel)
        gridfooter.attach(self.freightentry, 0, 1, 1, 1)
        gridfooter.attach(mischlabel, 1, 0, 1, 1)
        gridfooter.attach(self.mischentry, 1, 1, 1, 1)
        ...
        gridfooter.attach(transportmode_label, 5, 0, 1, 1)
        gridfooter.attach(self.transportmode_entry, 5, 1, 1, 1)   
